...
const COMMANDS = {
  ...
  projects: () => [
    ...
    { type: 'output', text: '  desert exploration with a 6-legged lizard cat. metroidvania-inspired.' },
    ...
    { type: 'output', text: '  save the sacred tree from the frost giants.' },
    ...
    { type: 'output', text: '  a fallen god must ascend from the void to rid the heavens of evil.' },
